...
x1 = linSineSweep(1000, 5000, .75, 1, impulsive, fs);  % Chirp
x2 = linSineSweep(1000, 5000, .75, 1, short, fs);      % Chirp
x3 = linSineSweep(1000, 5000, .75, 1, long, fs);       % Chirp
x4 = linSineSweep(1000, 5000, .75, 1, 10, fs);         % Chirp
...
maxGuitardBFS = 20*log10(data/1);       % Gain value in dBFS
